...
### export environment API_KEY ###
You can do this by either using .env file or updating your local environment variable to have a variable 'API_KEY' containing your API KEY
